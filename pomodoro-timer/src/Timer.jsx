...
export default function Timer ( {labelId, labelContent, displayId, displayContent, buttonStartPauseId, buttonResetId, isTimerRunning, handleReset, handleToggleTimer, children}) {
